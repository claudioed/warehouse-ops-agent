...
| [0004](./0004-llm-reasoner-behind-the-policy-layer.md) | A real LLM reasoner behind the policy layer, with MCP tools as its only actuators | Accepted (implemented for flow-balance) |
